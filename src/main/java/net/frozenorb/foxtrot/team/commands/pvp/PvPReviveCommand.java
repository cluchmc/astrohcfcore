...
public class PvPReviveCommand {
    ...
    public static void pvpRevive(Player sender, @Param(name = "player") UUID player) {
        ...
        int friendLives = Foxtrot.getInstance().getSoulboundLivesMap().getLives(sender.getUniqueId());
        ...
        // Use a friend life.
        Foxtrot.getInstance().getSoulboundLivesMap().setLives(sender.getUniqueId(), friendLives - 1);
